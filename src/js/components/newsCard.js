...
import { URL_NOT_FOUND_IMAGE } from '../config/main';
...
class NewsCard {
  ...
  create(card, notFoundUrl) {
    const isUserLogin = !!getCookie('user.name');
    const isSavedPage = !!getElement('.saved-page');
    ...
    cardTemplate.innerHTML = `<input type="hidden" class="publishedAt" value="">
